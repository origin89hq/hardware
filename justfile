...
gerbers:
    python3 tools/validate_gerbers.py boards/controller-a/gerber-rules.json boards/controller-a/build/2026-09-19/gerber.zip

# Check an export's silkscreen text against the A-33 label list. Defaults to the
# filed export.
silkscreen dxf="boards/controller-a/build/2026-09-19/board.dxf":
